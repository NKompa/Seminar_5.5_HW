# Условия игры: На столе лежит 2021 конфета. Играет игрок против бота. Первый ход определяется жеребьёвкой.
...
num = random.randint(1,2)                                               # жеребьёвка
...
while True:
    if player == player1:
        ...
        print(f'Бот: Я заберу {take} конфет(у).')
